...
\begin{description}
	...
	\item [MURA/C] Prior Murder Adjudications/Convictions
	\item [PCSOFF] PCS Offense Code
	\item [PCSSUB] PCS Offense Subcode
	\item [RACE] Ethnicity of Offender
	\item [RAPA/C] Prior Rape Adjudications/Convictions
	\item [SEX] Gender of Offender
	\item [SEXPRED] Sexually Violent Predator
	\item [VMA/C] Prior Voluntary Manslaughter Adjudications/Convictions
\end{description}

Additional features listed below can be found at \url{http://www.icpsr.umich.edu/icpsrweb/NACJD/studies/03450/detail}.
