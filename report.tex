...
The figure above shows the correlation between all tested attributes, with blue indicating uncorrelated attributes and yellow indicating highly correlated attributes.

\subsubsection{Top Correlated Attributes}
Ignoring correlation between binarized attributes (ex. GRADE\_1 and GRADE\_2), and trivial correlations such as that between DOSAGE and DOFAGE and PCSOFF and GRADE (since unique PCSOFFs are assigned unique GRADEs in the codebook),
...
\begin{itemize}
	\item Label: INCMIN
	\item Attributes: DOSAGE, SEX, RACE, COUNTY, DOFAGE, PCSOFF, PCSSUB, INCTYPE, FINE, GRADE, DAASS, DISP, COMPLETE, DOB\_UNO, DOS\_UNO, DOF\_UNO
\end{itemize}
\paragraph{With INCMAX}

\paragraph{Without INCMAX}
